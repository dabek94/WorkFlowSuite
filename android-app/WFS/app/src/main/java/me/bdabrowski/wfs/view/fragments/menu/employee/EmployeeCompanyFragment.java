...
import me.bdabrowski.wfs.databinding.FragmentBtmNavEmployeeCompanyBinding;
...
public class EmployeeCompanyFragment extends Fragment {
    ...
    private FragmentBtmNavEmployeeCompanyBinding companyBinding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (viewId == R.layout.fragment_btm_nav_employee_company_none) {
    ...
    private int createCompanyViewId(User user) {
        if (user.isUserEmployed()) {
            return R.layout.fragment_btm_nav_employee_company;
        } else {
            return R.layout.fragment_btm_nav_employee_company_none;
        }
    }
